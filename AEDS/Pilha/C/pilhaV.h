...
void pilhaV_destroi(pilhaV_t * lista);
...
erro_t pilhaV_busca(pilhaV_t * lista, dadosItem info, uint32_t * posicao);
bool_t pilhaV_estaVazia(pilhaV_t * lista);
void pilhaV_imprime(pilhaV_t * lista);
